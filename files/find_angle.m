function best_angle = find_angle(Image,nrow,s1,s2,n,reference,Pbase,K,p1,dh,top_point)
angle = [-20,-10,0,10,20,30];
score = [];
idx1 = round(1*s1/10:9*s1/10);
idx2 = round(2.5*s2/10:7.5*s2/10);
for ang = angle
    [lb, ub] = get_range(n, ang, Pbase, K, p1, nrow, dh,top_point);
