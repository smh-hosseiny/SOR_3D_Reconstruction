...
function [lb, ub] = get_range(n, ang, Pbase, K, p1, nrow, dh, top_point, bot_point, f,x,y,mask, iterations)
    if nargin < 14
        iterations = 100;
    end
    % Compute 'na' vector
    ...
    lb = fminsearchbnd(@(i) Cost(i, Pbase, dh, na, n, K, p1, nrow, bot_point, f, 'bot',bot_point, x,y,mask), ...
    ...
    ub = fminsearchbnd(@(i) Cost(i, Pbase, dh, na, n, K, p1, nrow, top_point, f,'top',bot_point,x,y,mask), ...
